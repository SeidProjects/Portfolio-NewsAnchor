...
$('.run-analysis.Button').click(function(){
    ...
    if(Portfolio.includes('Loading...')) {
      ...
      if(selected.includes("https://www.bloomberg.com/live/us") > 0){
            $('#success_video_container').append('<br><iframe id="bloomberg-stream" src="https://www.bloomberg.com/live/us?width=560&height=315&autoPlay=true&mute=false" width="560" height="315" frameborder="0" scrolling="no" allowfullscreen></iframe><br>');
        }
        if(selected.includes("https://www.youtube.com/watch?v=XOacA3RYrXk") > 0){
            $('#success_video_container').append('<br><iframe width="560.7" height="315" type="text/html" src="https://www.youtube.com/embed/XOacA3RYrXk?autoplay=1&fs=1&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=https://youtubeembedcode.com"></iframe><br>');
        }
      $('.sandboxtwo').toggleClass('loading');
      $('.loader').addClass('active');
      $.ajax({
